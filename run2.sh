...
./CodeCraft-2019 ../../../train_map/train${map_index}/car.txt ../../../train_map/train${map_index}/road.txt ../../../train_map/train${map_index}/cross.txt ../../../train_map/train${map_index}/presetAnswer.txt ../../../train_map/train${map_index}/answer.txt
